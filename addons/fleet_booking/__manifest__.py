{
    ...
    'depends': ['base', 'mail', 'web', 'hr', 'simply_fleet'],
    ...
    'data': [
        ...
        'views/fleet_booking_dashboard.xml',
        'views/templates.xml',
    ...
    'assets': {
        'web.assets_backend': [
            ...
            #'fleet_booking_dashboard/static/src/css/dashboard.css',
            'fleet_booking/static/src/js/dashboard_controller.js',
        ],
    },
